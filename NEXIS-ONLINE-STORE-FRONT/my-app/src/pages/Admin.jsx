...
const STORAGE_KEY = 'admin_order_statuses';
const ARCHIVE_KEY = 'admin_archived_orders';
        ...
        <div>
            ...
            {activeTab === 'archive' && (
                <div className="archive-admin">
                    ...
                    <div className="flex gap mb" style={{ marginBottom: '16px', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div style={{ color: '#666' }}>
